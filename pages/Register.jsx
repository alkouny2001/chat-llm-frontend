      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#1c1a17] text-[#f4f1ea] flex-col justify-between p-14 relative overflow-hidden">
        ...
        <div className="relative max-w-md">
          ...
          <h2 className="font-serif text-5xl leading-[1.1] tracking-tight">
            Every conversation, kept for good.
          </h2>
          <p className="text-[#a8a298] mt-6 text-base leading-relaxed">
            Create a free account and start a thread that never loses its place.
            No clutter — just your ideas, archived.
          </p>

          {/* Small feature list */}
          <ul className="mt-8 space-y-3">
            {['Free forever, no card required', 'Sync across every device', 'Your history, always searchable'].map((item) => (
              <li key={item} className="flex items-center gap-3 text-sm text-[#d8d2c6]">
                <span className="w-1.5 h-1.5 rounded-full bg-[#c8642e] shrink-0" />
                {item}
              </li>
            ))}
          </ul>
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="mb-9">
            ...
            <p className="text-[#8a8478] mt-2.5 text-sm">
              Set up your free account — it only takes a moment.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <p className="text-xs text-[#a8a298] mt-2">Use 8 or more characters.</p>
            </div>
          ...
          {/* Terms */}
          <p className="text-[#b0aa9e] text-xs mt-7 leading-relaxed">
            By creating an account, you agree to our{' '}
            <span className="text-[#8a8478]">Terms of Service</span>
            {' '}and{' '}
            <span className="text-[#8a8478]">Privacy Policy</span>.
          </p>

          {/* Footer */}
          <p className="text-[#8a8478] text-sm mt-4">
            Already have an account?{' '}
            <Link to="/login" className="text-[#c8642e] hover:text-[#1c1a17] font-semibold underline underline-offset-4 decoration-1 transition-colors">
              Sign in
            </Link>
          </p>
        </div>
